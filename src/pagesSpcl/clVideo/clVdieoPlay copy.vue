<template>
  ...
  >
    ...
    >
      <image :src="`${staticImgs}/lnmp/slide_indicator.png`" />
    </view> -->
    <!-- 新手引导步骤一 -->
    <!-- <view
    ...
    >
      ...
      <image
        :src="`${staticImgs}/lnmp/spcl_tip_one.png`"
        class="tip-bubble"
      />
      <image
        :src="`${staticImgs}/lnmp/spcl_detail_next.png`"
        class="tip-button"
      />
      <view class="set-box">
        <view class="inner-box">
          <view class="set-boxImg">
            <image
              :src="`${staticImgs}/lnmp/set_spcl_btn_inner.png`"
              class="set-btn-inner"
            />
          </view>
    ...
    >
      ...
      <image
        :src="`${staticImgs}/lnmp/spcl_tip_two.png`"
        class="tip-bubble"
      />
      <image
        :src="`${staticImgs}/lnmp/spcl_detail_next.png`"
      ...
      <view class="right-icon">
        <image
          :src="`${staticImgs}/lnmp/video-preview-icon.png`"
...
<script>
// import clVideo from "../../components/cl-video/cl-video";
