    ...
    >
      ...
      <view class="login-top-box" @click="isLogin()">
        ...
        <view class="tx-content">
          ...
          <view v-if="loginFlag && lyhMemberLevel" class="hly-member-icon">
            <view class="hly-member-img">
              <image
                :src="`${staticImgs}/lnmp/lyhMember/member-${lyhMemberLevel}.png`"
              />
            </view>
      ...
      <view class="cx-des">
        ...
        >
          <view style="width: 92%; display: flex; align-items: center">
            <image class="sign" :src="`${staticImgs}/lnmp/yp-icon.png`" />
            <text class="title">我的彩铃：</text>
            <text v-if="!loginFlag" class="content" @click="navigateToLogin()">
              登录后显示
            </text>
        ...
        >
          <view style="width: 92%; display: flex; align-items: center">
            <image class="sign" :src="`${staticImgs}/lnmp/sp-icon.png`" />
